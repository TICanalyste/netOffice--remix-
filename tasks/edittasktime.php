...
//if ($teamMember == "false" && $projectsFilter == "true" && !loggedUserIsAdmin()) {
...
//$pageTitle= "<span>Bonjour ".$_SESSION['nameSession'].",<br/>Bienvenue dans le formulaire d'encodage des <strong>$title_type</strong>.</span>";
...
$block1->openForm("../tasks/edittasktime.php?id=$id&task=$task&action=edit$popup_addon#" . $block1->form . "Anchor");
...
<tr class='odd'>
  ...
  <td><input size='20' value='" . $taskTimeDetail->tim_hours[0] . "' style='width: 150px;' name='hr' maxlength='6' type='text' onChange='timeCheck(this);'></td>
</tr>
<tr class='odd'>
...
<tr class='odd'>
  ...
  <td><input type='SUBMIT' value='" . $strings["update"] . "'><input type='button' name='cancel' value='" . $strings['cancel'] . "' onClick='$cancel_action'></td>
</tr>";
