...
echo "<form action='timesheets_report.php?dateCalend=".$dateCalend."' method='post'>".
	...
	buildLink("../_addon/timesheets_report.php?dateCalend=$datePast", $strings["previous"], LINK_INSIDE).
	" | " .
	buildLink("../_addon/timesheets_report.php", $strings["today"], LINK_INSIDE) . 
	" | " .
	buildLink("../_addon/timesheets_report.php?dateCalend=$dateNext", $strings["next"], LINK_INSIDE) .
	"</strong></span>";
...
echo "<div id='timesheet_summary' style='width:99%;height:680px;padding:0px;'><iframe frameborder='0' src='$applicationFolder/_addon/addon_hours_summary.php?dateCalend=$dateCalend&worker_id=$worker_id&display=".TASKTIME_MONTH_SUMMARY."' type='text/html' width='100%' height='100%'></iframe></div>";
