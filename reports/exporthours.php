...
if ($comptListHours != "0") {
    ...
    $dump_buffer .= "\"" . $strings["organization"] . "\",\"" . $strings["project"] . "\",\"" . $strings["task"] . "\",\"" . $strings["comment"] . "\",\"" . $strings["name"] . "\",\"" . $strings["date"] . "\",\"" . $strings["type"] . "\",\"" . $strings["service"] . "\",\"" . $strings['hours'] . "\"" . $crlf;
    // Without Project Type
    //$dump_buffer .= "\"" . $strings["organization"] . "\",\"" . $strings["project"] . "\",\"" . $strings["task"] . "\",\"" . $strings["comment"] . "\",\"" . $strings["name"] . "\",\"" . $strings["date"] . "\",\"" . $strings["service"] . "\",\"" . $strings['hours'] . "\"" . $crlf;
    ...
    for ($i = 0;$i < $comptListHours;$i++) {
        ...
        // task name
        $dump_buffer .= "\"" . $listHours->tim_tas_name[$i] . "\",";
        // task comment
        $dump_buffer .= "\"" . $listHours->tim_comments[$i] . "\",";
        // member name
